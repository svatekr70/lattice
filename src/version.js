/**
 * Verze a odkazy knihovny — jediný zdroj pravdy pro běhový kód (VERZE musí odpovídat
...
export const DEMO_URL = HOMEPAGE + 'demo/';
export const GITHUB_URL = 'https://github.com/svatekr70/lattice';
export const AUTHOR = 'Rudolf Svátek';
