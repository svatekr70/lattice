...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/svatekr70/lattice@v1.9.0/dist/lattice.css">
<div id="grid"></div>
<script type="module">
  import { Lattice } from 'https://cdn.jsdelivr.net/gh/svatekr70/lattice@v1.9.0/dist/lattice.min.js';
  new Lattice('#grid', { id: 'moje', columns, data });
</script>
```
Pro produkci připni verzi (`@v1.9.0`) nebo commit; `@main` je „vždy nejnovější" (jsDelivr
cachuje větev ~12 h).
