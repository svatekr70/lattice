...
const RAW_GROUPS = [
  ...
  quickSearch: true,   // pole „Hledat ve všem…" v toolbaru
      ...
      },
      {
        ...
        blurb: 'Každý sloupec má vlastní filtr podle typu: text, číslo/rozsah, výběr, multiselect, datum (rozsah i od/do), ano/ne. Typ lze přepínat v dialogu Sloupce.',
